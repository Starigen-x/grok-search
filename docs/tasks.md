...
| # | 功能 | 规模 | 验收标准（怎么算做完） | 老板怎么验证 | 前置 | 状态 |
|---|---|---|---|---|---|---|
| 6 | 部署到 pipi-nyc 服务器 | M | systemd 常驻服务开机自启；https://ai.starigen.com/grok-search/ 返回存活 JSON；无令牌访问 /mcp 返回 401；从外部网络用令牌连接可列出 3 个工具并完成一次真实搜索 | 手机浏览器打开 https://ai.starigen.com/grok-search/ 看到 status ok | #5 | 待验收 |
